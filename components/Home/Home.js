...
import SplitLogo from "../../public/images/logo/LOGO.png";
...
import shapeOne from "../../public/images/bg/icon-shape/icons8-iot-10.png";
import shapeTwo from "../../public/images/bg/icon-shape/icons8-iot-56.png";
import shapeThree from "../../public/images/bg/icon-shape/icons8-iot-66.png";
import shapeFour from "../../public/images/bg/icon-shape/icons8-iot-64.png";
              ...
              <div className="inner text-center mt--140">
                <h1 className="title display-one">
                  ...
                  <span className="header-caption">
                    <span className="cd-headline rotate-1" style={{paddingRight:"7rem"}}>
                      <span className="cd-words-wrapper"  >
                        <b
                       
                          className={
                            visibleIndex === 0
                              ? "is-visible bg-blueish"
                              : "is-hidden bg-blueish"
                          }
                        >
                          Iot platforms
                        </b>
                ...
                <p className="description">
                  Unleash BoxTech's potential. Use the Iot <br />{" "}
                ...
                <div className="form-group">
                  <textarea
                    ...
                    cols="30"
                    rows="2"
                    placeholder="Enter a prompt, for example: a query about IOT"
                  ></textarea>
            ...
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle">
                  <span className="bg-blueish">
                    BoxTech UNLOCKS THE POTENTIAL of IOT
                  </span>
                </h4>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle">
                  <span className="bg-blueish">Assisting individuals & companies</span>
                </h4>
                <h2 className="title mb--60">
                  work Smarter, Not <br /> Harder with BoxTech
                </h2>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle ">
                  <span className="bg-blueish">IOT Collaboration</span>
                </h4>
                <h2 className="title mb--20">
                  IOT Devices for seamless
                  <br /> collaboration
                </h2>
                <Link
                  className="btn-default btn-large color-blacked bg-text"
                  href="/contact"
                >
                  Try It Now{" "}
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              ...
              >
                <h4 className="subtitle">
                  <span className="bg-blueish">Pricing</span>
                </h4>
